...
## 项目简介
[cite_start]CampusHub 是一个统一的校园互助服务平台 [cite: 8][cite_start]。大学校园中，学生之间存在大量日常互助需求，例如快递代取、学习辅导、二手物品交换、活动组队等 [cite: 7][cite_start]。目前这些需求散落在微信群、QQ群、贴吧等平台，导致信息碎片化、匹配效率低、且缺乏信任机制 [cite: 7][cite_start]。CampusHub 旨在解决这些痛点，让学生能够方便地发布需求、发现匹配、建立信任、完成协作 [cite: 8]。
...
## 团队成员
* [cite_start]**需求负责人兼组长**: 郑嘉鸿 [cite: 81]
* [cite_start]**架构负责人**: 汪一航 [cite: 82]
* [cite_start]**开发负责人**: 何刘磊 [cite: 83]
* [cite_start]**测试负责人**: 杨宗乔 [cite: 84]
